...
from message_broker.message_broker.rabbit_mq.consumer.callback.backend_callback import (
    BackendCallBack,
)
...
if __name__ == "__main__":
    ...
    BackendConsumer(
        channel, observer, "backend_routing_key", "backend_exchange", "backend_queue"
    )
    rabbit.start()
